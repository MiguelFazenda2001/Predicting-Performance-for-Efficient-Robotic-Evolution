import numpy as np
from original_tcn import EpisodeTCN
...
def load_data(save_path=SAVE_PATH):
    ...
    try:
        ...
        shutil.copy(f"data/y_mean.npy", f"{save_path}/y_mean.npy")
        shutil.copy(f"data/y_std.npy", f"{save_path}/y_std.npy")
...
if __name__ == "__main__":
    ...
    save_path = f"models/{model_folder}_tcn"
    episode_model, val_losses, losses, mse_success, mse_duration = train_episodetcn(train_loader, input_dim, val_loader, save_path=save_path)
    plot_training_curves(val_losses, losses, mse_success, mse_duration, save_path=save_path, model_name="episodetcn")
