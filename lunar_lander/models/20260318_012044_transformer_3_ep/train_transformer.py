...
def load_data(save_path=SAVE_PATH):
    ...
    try:
        ...
        shutil.copy(f"data/3_ep/x_mean.npy", f"{save_path}/x_mean.npy")
        shutil.copy(f"data/3_ep/x_std.npy", f"{save_path}/x_std.npy")
        shutil.copy(f"data/3_ep/y_mean.npy", f"{save_path}/y_mean.npy")
        shutil.copy(f"data/3_ep/y_std.npy", f"{save_path}/y_std.npy")
