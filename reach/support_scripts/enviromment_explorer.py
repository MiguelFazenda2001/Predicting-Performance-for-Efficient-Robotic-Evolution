...
if __name__ == "__main__":
    env = gym.make('FetchReachDense-v4', max_episode_steps=500)

    results = explore_observation_space(env, episodes=5000, steps_per_episode=100)
    ...
    # Save to file
    with open("observation_limits_13_obs.json", "w") as f:
