...
_10_episodes_sr_files = glob.glob("../evolutionary_history/Predictive_VS_Fitness/30_total_episodes_10_episodes_sr_fitness_evolution/*.json")
...
_3_episodes_sr_files = glob.glob("../evolutionary_history/Predictive_VS_Fitness/30_total_episodes_3_episodes_sr_fitness_evolution/*.json")
...
df = pd.DataFrame(
    ...
    load_data(_10_episodes_sr_files, "Success Rate Evolution (10 episodes)") +
    ...
    load_data(_3_episodes_sr_files, "Success Rate Evolution (3 episodes)")
